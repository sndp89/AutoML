...
def draw_roc_plot(nt_id, mdl_prefix, y_score, y_true, model_type, data_type):
    ...
    print('/home/' + nt_id + '/' + 'mla_' + mdl_prefix + '/' + str(model_type) + '/' + str(model_type) + ' Model - ROC for ' + str(data_type) + ' data.png')
    plt.savefig('/home/' + nt_id + '/' + 'mla_' + mdl_prefix + '/' + str(model_type) + '/' + str(model_type) + ' Model - ROC for ' + str(data_type) + ' data.png', bbox_inches='tight')
    plt.close()

# Generate KS Chart

def draw_ks_plot(nt_id, mdl_prefix, model_type):

    writer = ExcelWriter('/home/' + nt_id + '/' + 'mla_' + mdl_prefix + '/' + str(model_type) + '/KS_Charts.xlsx')

    for filename in glob.glob('/home/' + nt_id + '/' + 'mla_' + mdl_prefix + '/' + str(model_type) + '/KS ' + str(model_type) + ' Model*.xlsx'):
...
def draw_confusion_matrix(nt_id, mdl_prefix, y_pred, y_true, model_type, data_type):
    ...
    print('/home/' + nt_id + '/' + 'mla_' + mdl_prefix + '/' + str(model_type) + '/' + str(model_type) + ' Model - Confusion Matrix for ' + str(data_type) + ' data.png')
    plt.savefig('/home/' + nt_id + '/' + 'mla_' + mdl_prefix + '/' + str(model_type) + '/' + str(model_type) + ' Model - Confusion Matrix for ' + str(data_type) + ' data.png', bbox_inches='tight')
    plt.close()    
    
# Model validation
    
def model_validation(nt_id, mdl_prefix, data, y, model, model_type, data_type):
    ...
    draw_roc_plot(nt_id, mdl_prefix, y_score, y_true, model_type, data_type)
    decile_table.to_excel('/home/' + nt_id + '/' + 'mla_' + mdl_prefix + '/' + str(model_type) + '/KS ' + str(model_type) + ' Model ' + str(data_type) + '.xlsx',index=False)
    draw_confusion_matrix(nt_id, mdl_prefix, y_pred, y_true, model_type, data_type)
