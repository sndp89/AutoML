 ...
 * http://hayageek.com/
 */
/* This function check_data_to_display_oot is written to ensure that OOT1 can be uploaded only after DEV is successfully uploaded
 and OOT2 can be uploaded on successful upload of OOT1*/
	function check_data_to_display_oot(){
		var value_of_data_set_names = document.getElementById("file_name_for_python").value;
		console.log(value_of_data_set_names)
		var split_data_names = value_of_data_set_names.split(";");
		console.log(split_data_names);
		if(split_data_names.length ==2){
			//document.getElementById("INPUT_FILE_DEV_div").style.pointerEvents = "none";
			document.getElementById("INPUT_FILE_OOT1_div").style.pointerEvents = "auto";
		}
		if(split_data_names.length ==3){
			//document.getElementById("INPUT_FILE_OOT1_div").style.pointerEvents = "none";
			document.getElementById("INPUT_FILE_OOT2_div").style.pointerEvents = "auto";		}
		if(split_data_names.length ==4){
			//document.getElementById("INPUT_FILE_OOT2_div").style.pointerEvents = "none";
		}

	}
var file_extension_ind=0;
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
		...
		if(file_name.includes('csv') || file_name.includes('txt')){
                return true;
		}
		else{
		...
		return	false
            ...
            onSuccess: function (files, response, xhr, pd) {    
				...
				var previous_file = document.getElementById("file_name_for_python").value;
				var string_of_file_name = previous_file+";"+files;
				$("#file_name_div input").val(string_of_file_name)
				check_data_to_display_oot()
	    },
