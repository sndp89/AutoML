...
#     # Build KS Table
    ...
    overall_cnt['spread'] = builtin.abs(overall_cnt['%Dist_Target']-overall_cnt['%Dist_non_Target'])
    decile_table=overall_cnt.round(2)
    print("KS_Value =", builtin.round(overall_cnt.spread.max(),2))
    ...
    return auroc,RFaccuracy,builtin.round(overall_cnt.spread.max(),2), y_score, y_pred, y_true, overall_cnt
