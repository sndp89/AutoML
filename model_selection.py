...
def select_model(nt_id, mdl_prefix, model_selection_criteria, dataset_to_use):
    ...
    os.chdir('/home/' + nt_id + '/' + 'mla_' + mdl_prefix)
    ...
    df.to_excel('/home/' + nt_id + '/' + 'mla_' + mdl_prefix + '/metrics.xlsx')
    return df